...
#         train_op = optimizer.apply_gradients(grads_and_vars, global_step=global_step)
        ...
        early_train_op= tf.train.AdamOptimizer(cnn.learning_rate)
        late_train_op = tf.train.MomentumOptimizer(cnn.learning_rate,0.9,use_nesterov=True)        
#         late_train_op = tf.train.MomentumOptimizer(cnn.learning_rate,0.9)        
...
#         train_summary_op = tf.summary.merge([loss_summary, acc_summary, grad_summaries_merged])
        ...
        def train_step(x_batch, y_batch, learning_rate):
            ...
            train_op = train_op_1 if tf.train.global_step(sess, global_step) <=(train_input_size/FLAGS.batch_size)*3 else train_op_2
            #4 epoch 10136, 5 epoch 12670 steps (2534)
...
#         max_learning_rate = 0.005
        ...
        for batch in batches:
            ...
            if tf.train.global_step(sess, global_step) == ((train_input_size/FLAGS.batch_size)*3)+1: ##(2534*3)+1:
